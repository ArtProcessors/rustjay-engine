...
fn segments_editor(
    ui: &mut egui::Ui,
    lighting: &mut qplayer_core::LightingConfig,
    ...
    for (i, seg) in lighting.segments.iter_mut().enumerate() {
        ...
        ui.horizontal(|ui| {
            ...
            egui::ComboBox::from_id_salt(("lx_seg_white", i))
                ...
                .show_ui(ui, |ui| {
                    use qplayer_core::lighting::WhiteMode;
                    for w in [
                        WhiteMode::Off,
...
fn profiles_editor(ui: &mut egui::Ui, lighting: &mut qplayer_core::LightingConfig) -> bool {
    let mut changed = false;
    ...
    for p in qplayer_core::lighting::builtin_profiles() {
        ui.label(
