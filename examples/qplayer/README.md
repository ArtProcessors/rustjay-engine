...
(QLab-style show control), built on the rustjay engine. Audio via symphonia/cpal,
video via FFmpeg, plus OSC show control, lighting cues (sACN), and NDI/Syphon output.
